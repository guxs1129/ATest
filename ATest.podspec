...
Pod::Spec.new do |s|
  s.name             = 'ATest'
  s.version          = '0.1.0'
  s.summary          = 'A short description of ATest.'
...
TODO: Add long description of the pod here.
  ...
  s.homepage         = 'https://github.com/guxs1129@163.com/ATest'
  # s.screenshots     = 'www.example.com/screenshots_1', 'www.example.com/screenshots_2'
  s.license          = { :type => 'MIT', :file => 'LICENSE' }
  s.author           = { 'guxs1129@163.com' => 'guxs@linkstec.com' }
  s.source           = { :git => 'https://github.com/guxs1129@163.com/ATest.git', :tag => s.version.to_s }
